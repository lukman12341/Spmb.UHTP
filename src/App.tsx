        ...
        <div className="w-full max-w-7xl mx-auto px-6 md:px-12 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-6 animate-slide-up">
              ...
              <h1 className="text-slate-900 text-4xl md:text-5xl lg:text-6.5xl font-extrabold italic leading-[1.15] tracking-tight font-display">
                Selamat Datang di Situs <br />
                <span className="text-primary inline-block mt-1">PMB Online</span>
              </h1>
              ...
              <div className="flex flex-wrap items-center gap-4 pt-2">
                <button 
                  ...
                  className="w-full sm:w-auto px-8 py-3.5 rounded-xl bg-primary hover:bg-[#007066] text-white font-semibold text-sm transition-colors duration-300 shadow-md shadow-primary/15 cursor-pointer"
                >
                  Daftar Sekarang
                </button>
                <button 
