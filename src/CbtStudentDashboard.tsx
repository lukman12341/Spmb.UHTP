              ...
              <form onSubmit={handleWawancaraSubmit} className="space-y-10">
                ...
                <div className="flex items-center gap-3 pt-8 border-t border-slate-100">
                  <button 
                    ...
                    className="px-8 py-3.5 uhtp-bg-gradient-r text-white rounded-xl shadow-lg shadow-primary/20 font-bold text-xs uppercase tracking-wider transition-all duration-300 active:scale-[0.98] flex items-center justify-center gap-2 disabled:opacity-50 cursor-pointer"
                  >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
          ...
          <div className="bg-white rounded-3xl p-8 shadow-sm border border-slate-100 flex flex-col space-y-8 animate-in slide-in-from-left-8 duration-700">
            ...
            <div className="space-y-6">
              ...
              <div className="p-6 uhtp-bg-gradient-tr rounded-2xl text-white space-y-4 shadow-lg shadow-primary/10 group/bank">
                <div className="flex items-center gap-3">
            ...
            <form onSubmit={handleRegistrasiSubmit} className="flex-1 flex flex-col space-y-6">
              ...
              <div className="flex flex-col gap-3 max-w-sm mx-auto w-full pt-4">
                <button 
                  ...
                  className="w-full group relative py-3.5 uhtp-bg-gradient-r text-white rounded-xl font-bold text-xs uppercase tracking-wider transition-all duration-300 shadow-md shadow-primary/25 disabled:opacity-50 active:scale-98 overflow-hidden cursor-pointer"
                >
    ...
    <div className="flex h-screen w-full bg-slate-50 font-sans overflow-hidden animate-in fade-in duration-700">
      ...
      <div className="w-72 bg-slate-900 flex flex-col p-8 hidden lg:flex relative overflow-y-auto border-r border-slate-800 custom-scrollbar">
        ...
        <div className="mb-6 text-center px-2 relative z-10">
          <div className="relative size-20 mx-auto rounded-full p-1 uhtp-profile-ring-gradient shadow-2xl mb-4 transition-transform duration-500 hover:rotate-6">
            {photoUrl ? (
              <img src={photoUrl} alt="Profil" className="w-full h-full rounded-full object-cover" />
            ) : (
              <div className="w-full h-full rounded-full flex items-center justify-center uhtp-bg-gradient-tr text-white">
